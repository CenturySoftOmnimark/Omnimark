...
namespace AmazonProductAdvtApi
{
    class SignedRequestHelper
    {
        ...
        private byte[] secret;
        private HMAC signer;
        private const string REQUEST_URI = "/Products/2011-10-01";
        private const string REQUEST_METHOD = "POST";
        public string Gsignature = null;
        ...
        public string Sign(IDictionary<string, string> request)
        {
            ...
            this.Gsignature = this.PercentEncodeRfc3986(signature);
